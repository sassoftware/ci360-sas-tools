...
filename blogs "/innovationlab-export/innovationlab/homes/Noah.Powers@sas.com/export/blog_json_out.json";
filename map '/innovationlab-export/innovationlab/homes/Noah.Powers@sas.com/export/blog_json_map.json';
...
libname newsgf JSON fileref=blogs map='/innovationlab-export/innovationlab/homes/Noah.Powers@sas.com/DemoCode/json/custom_json_map.json';